...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6 bg-gradient-to-br from-primary via-accent to-secondary">
  <div className="w-full max-w-md p-8 space-y-6 bg-white/10 rounded-3xl shadow-2xl backdrop-blur-md border border-white/10">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 mt-1 bg-white/5 text-foreground border border-white/10 rounded-xl placeholder:text-foreground/50
                     focus:outline-none focus:ring-2 focus:ring-accent/70 focus:border-transparent transition-all duration-300"
